...
<!-- #region deletable=true editable=true -->
_**Figure 6.36**. Two LineStrings that both intersect and touch each other._
...
<!-- #region deletable=true editable=true -->
_**Figure 6.37**. A map of Points and the two Polygon objects (in red) which we want to use for making the selection._
...
<!-- #region editable=true slideshow={"slide_type": ""} -->
_**Figure 6.38**. Selecting Points within red Polygons using spatial join technique._
...
_**Figure 6.39**. Polygons that contain at least one Point object._
